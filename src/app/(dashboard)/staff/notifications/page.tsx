...
export default function NotificationsPage() {
  ...
  const [notifications, setNotifications] = useState([
    { id: 1, title: 'تحديث بجدول الحصص', desc: 'تم تعديل جدول حصصك ليوم غد. يرجى المراجعة.', time: 'منذ ساعتين', type: 'info', isNew: true },
    { id: 2, title: 'تذكير: رصد درجات', desc: 'يرجى رصد درجات المشاركة للفصل الثالث الثانوي قبل نهاية الأسبوع.', time: 'أمس', type: 'warning', isNew: true },
    { id: 3, title: 'تقييم أداء معتمد', desc: 'تم اعتماد تقييم الأداء الشهري الخاص بك.', time: 'منذ يومين', type: 'success', isNew: false },
    { id: 4, title: 'حدث جديد: اجتماع الهيئة التدريسية', desc: 'اجتماع الهيئة التدريسية غدا لمناقشة سير العملية التعليمية.', time: 'الأسبوع الماضي', type: 'star', isNew: false },
  ]);
    ...
    <div className="space-y-6 animate-in fade-in duration-500">
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 mb-2">
        <div>
          ...
          <p className="text-sm text-slate-500 dark:text-slate-400 mt-1">سجل التنبيهات والأحداث الخاصة بك وبالمدرسة</p>
        </div>
        <button
